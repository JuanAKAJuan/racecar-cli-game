...
{
    std::cout << "   ___________ ______   ____             _            " << std::endl;
    std::cout << "  / ____/ ___// ____/  / __ \\____ ______(_)___  ____ _" << std::endl;
    std::cout << " / /    \\__ \\/ /      / /_/ / __ `/ ___/ / __ \\/ __ `/" << std::endl;
    std::cout << "/ /___ ___/ / /___   / _, _/ /_/ / /__/ / / / / /_/ / " << std::endl;
    std::cout << "\\____//____/\\____/  /_/ |_|\\__,_/\\___/_/_/ /_/\\__, /  " << std::endl;
